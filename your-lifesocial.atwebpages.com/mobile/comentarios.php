...
<header>
	...
	<style type="text/css">
	div#publish{width: 90%;max-width:400px;height: 180px;display: block;margin: auto;border: none;border-radius: 5px;background: #FFF;box-shadow: 0 0 6px #A1A1A1;margin-top: 30px;}
	...
	div.pub span{display: block; margin: auto;width: 380px;margin-top: 10px;margin-left: 10px; width: 90%;}
