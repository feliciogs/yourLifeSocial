...
<header>
	...
	/*Notificações*/
	div.notif{width:90%;max-width: 400px;height: 70px;display: block;margin: auto;border: none;border-radius: 5px;background-color: #FFF;box-shadow: 0 0 6px #A1A1A1; margin-top: 30px; text-align: center;}
	div.notif a{color: #666; text-decoration: none; position: relative;top: 25%;width: 100%;padding-left: 10px;padding-right: 10px;}
