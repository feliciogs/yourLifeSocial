...
<header>
	...
	<style type="text/css">
	div#publish{width: 90%;max-width: 400px; height: 260px;display: block;margin: auto;border: none;border-radius: 5px;background: #FFF;box-shadow: 0 0 6px #A1A1A1;margin-top: 30px;}
	div#publish textarea{width: 90%;height: 110px;display: block;margin: auto;border-radius: 5px;padding-left: 5px;padding-top: 5px;border-width: 1px;border-color: #A1A1A1;}
	div#publish img{margin-top: 0px;margin-left: 10px;width: 40px;cursor: pointer;}
	div.pub{width: 90%;max-width: 400px;display: block;margin: auto;border: none;border-radius: 5px;background-color: #FFF;box-shadow: 0 0 6px #A1A1A1; margin-top: 30px;padding-bottom: 10px;}
	...
	div.pub span{display: block; margin: auto;width: 90%;margin-top: 10px;}
	...
	div#love{width: 90%;max-width: 400px; height: 30px;display: block;margin: auto; border: none; border-radius: 5px;background-color:#007fff;}
...
<body>
	<div id="publish">
		<form method="POST" enctype="multipart/form-data" class="text-center">
            ...
            <input class="form-control-file" type="file" id="file-input" name="file" title="Insira uma imagem" >
